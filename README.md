...
Como cada filme tem um id único, basta contar todos os ids. Para isso, a variável `a` recebe `moviesData["Movie_Id"].size`, onde *Movie_Id* é o nome da coluna desejada e a propriedade `size` retorna a quantidade de elementos nessa coluna.<br/><br/>
